...
def bridge_problem3(here):
    ...
    zet = frozenset
    here.append('light')
    return lowest_cost_search((zet(here), zet()), bsuccessors2, all_over, bcost) # <== your arguments here
...
def bridge_problem4(here):
    ...
    zet = frozenset
    here.append('light')
    return lowest_cost_search((zet(here), zet()), bsuccessors2, lambda x: not x[0], bcost) # <== your arguments here
