...
def bridge_problem(start, goal=None):
    # your code here if necessary
    return lowest_cost_search(start, bsuccessors2, lambda x:x[:3]==(0,0,0), bcost) # <== insert arguments here
