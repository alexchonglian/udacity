...
def allmax(iterable, key=None):
    ...
    maxv = max(iterable, key=key)
    return [i for i in iterable if key(i) == key(maxv)]
...
def test():
    ...
    hs = [['6C', '7C', '8C', '9C', 'TC'], ['6D', '7D', '8D', '9D', 'TD'], ['9D', '9H', '9S', '9C', '7D'], ['TD', 'TC', 'TH', '7C', '7D']]
    allmax(hs, key=hand_rank)
    return 'tests pass'
